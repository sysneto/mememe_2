...
//  Updated by Kadar Toth Istvan on 19/05/15.  - Fixed: initial Editor load
...
class EditViewController: UIViewController, UITextFieldDelegate, UIImagePickerControllerDelegate, UINavigationControllerDelegate {
    ...
    // go back to memes list
    func gotoMemes(){
        let detailController: UITabBarController! = self.storyboard!.instantiateViewControllerWithIdentifier("MemeTabBarController")! as! UITabBarController
    ...
    // When cancel clicked go to Memes
